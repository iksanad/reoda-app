...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="rounded-xl border border-stroke bg-white shadow-sm p-6 flex flex-col items-center text-center">
        ...
        {{-- <div class="mt-4 w-full rounded-xl bg-linear-to-br from-reoda to-reoda-dark p-5 text-white text-center">
            ...
            <p class="text-xs text-white/70 mb-4">Bagikan kode ini ke teman! Mereka dapat diskon Rp 50.000 dan kamu dapat hadiah setelah mereka bayar sewa pertama.</p>
