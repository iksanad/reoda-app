...
@php
    ...
    $showPln   = $activeContract && in_array($elecConf, ['token','postpaid']) && $plnId;
...
<div class="mb-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="rounded-xl border border-yellow-200 bg-yellow-50 p-5 flex flex-col gap-3">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-bold text-yellow-800 text-sm">Listrik {{ $elecConf === 'token' ? '(Token Prabayar)' : '(Pascabayar)' }}</p>
                <p class="text-xs text-yellow-600">ID Pelanggan PLN</p>
            </div>
        </div>
    ...
    <div class="rounded-xl border border-blue-200 bg-blue-50 p-5 flex flex-col gap-3">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-bold text-blue-800 text-sm">Air (PDAM)</p>
                <p class="text-xs text-blue-600">ID Pelanggan PDAM</p>
            </div>
        </div>
